    ...
    <div class="user">
        <div class="menu">
            <el-menu active-text-color="#B18600" :default-active="$route.path" class="el-menu-vertical-demo">
                <div class="top">
                    <svg t="1691401227204" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="10477" width="20" height="20">
                        <path
                            ...
                            p-id="10478" fill="#7f7f7f" data-spm-anchor-id="a313x.search_index.0.i30.510d3a816LGRG2"
                            class="selected"></path>
                    </svg>
                    <span>会员中心</span>
                </div>
...
<script setup lang="ts">
    ...
    //user子路由路径
    let routerlink = ref(['/user/confirm','/user/bookOrder','/user/userMange','/user/accountInfo','/user/feedback'])
    //点击跳转路由
